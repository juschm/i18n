...
var _placeholderRegistryHints = require('./placeholderRegistryHints');
...
var PlaceholderRegistry = (function () {
  ...
  _createClass(PlaceholderRegistry, [{
    ...
    value: function toMap() {
      ...
      try {
        for (var _iterator = _getIterator(this._byFingerprint.values()), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    value: function _ensureNamesForTag(placeholder) {
      ...
      var nameHint = _placeholderRegistryHints.getNameHintForPlaceholder(placeholder);
    ...
    value: function ensureNameForPlaceholder(placeholder) {
      ...
      var basename = _placeholderRegistryHints.getNameHintForPlaceholder(placeholder),
          name = basename;
